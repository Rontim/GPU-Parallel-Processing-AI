...
# MNIST GAN Demo Page
    ...
    gan_diagram = """
    <div style="text-align: center;">
        <img src="https://miro.medium.com/v2/resize:fit:1400/1*XKanAdUxHMuVNHJTpVtHvg.png" 
             alt="GAN Architecture" style="max-width: 100%; height: auto;">
    ...
    st.image("https://machinelearningmastery.com/wp-content/uploads/2019/04/Example-of-MNIST-Handwritten-Digit-Images-Generated-by-a-GAN-after-990-Training-Epochs.png", 
             caption="Example of synthetic MNIST digits generated by GAN")
